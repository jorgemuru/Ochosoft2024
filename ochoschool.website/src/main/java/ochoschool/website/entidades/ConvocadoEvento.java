...
public class ConvocadoEvento implements Serializable{
	...
	public ConvocadoEvento(Estudiante estudiante, ConvocatoriaEvento convocatoria, String estadoAsistencia, Double nota, String registraAsistencia,
			Date fechaHoraRegAsis, String token) {
		super();
		this.estudiante = estudiante;
		this.convocatoriaEvento = convocatoria;
		this.estadoAsistencia = estadoAsistencia;
